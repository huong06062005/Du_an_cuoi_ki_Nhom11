...
@section('content')
    {{-- Khối Banner Chính --}}
    <div class="relative w-full h-[550px] bg-cover bg-center flex flex-col justify-center items-center text-center px-4" style="background-image: url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600');">
        ...
        <div class="relative z-10 w-full mb-10">
            <h1 class="text-white text-5xl font-black uppercase tracking-wider mb-3 drop-shadow-lg">
